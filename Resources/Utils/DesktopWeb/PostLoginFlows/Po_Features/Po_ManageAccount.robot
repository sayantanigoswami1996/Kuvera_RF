...
Verify Invite Manager Screen
    ...
    Verify Element And Text  ${KU_W_feature_addManagerPoint1}  ${e_feature_addManagerPoint1}
    Verify Element And Text  ${KU_W_feature_addManagerPoint2}  ${e_feature_addManagerPoint2}
    Verify Element And Text  ${KU_W_feature_addManagerPoint3}  ${e_feature_addManagerPoint3}
