...
Verify PostLogin US Stocks Portflio Menu Navigation With KYC
    ...
    Verify Navigation To Explore Funds And Import Tab  ${KU_W_portfolio_USStocks_exploreUSStocks}  ${KU_W_portfolio_USStocks_allUSSStocks}  ${e_portfolio_USStocks_allUSStocks}   ${KU_W_portfolio_USStocks_importTitle}  ${KU_W_portfolio_USStocks_linkYourVestedAcc}  ${e_portfolio_USStocks_linkYourVestedAcc}
    Go Back
