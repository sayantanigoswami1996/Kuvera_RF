...
Verify Loan Landing Page Navigation
  ...
  Wait Until Element Is Enabled  ${KU_W_loanHeaderTitle}   timeout=3s
  ...
  Wait Until Element Is Enabled  ${KU_W_loginPageTitle}     timeout=3s
  Verify Element And Text  ${KU_W_loginPageTitle}     ${e_loginPage}
  Go Back
  Wait Until Element Is Enabled  ${KU_W_loanCalculatorTitle}   timeout=3s
...
Verify Texts On Loan Landing Page    
  ...
  # Instant Approval 
   Wait Until Element Is Enabled  ${KU_W_loanRedemptionTitle}   timeout=1s
   Scroll Untill View   ${KU_W_loanRedemptionTitle}
  ...
  # Super Affordable
   Wait Until Element Is Enabled  ${KU_W_saveSuperAffordableTitle}   timeout=1s
  ...
  #Easy Start Saver
   sleep   2s
   Wait Until Element Is Enabled   ${KU_W_startSaveTitle}   timeout=1s
   ...
   #Get Loan Against MF
   Wait Until Element Is Enabled  ${KU_W_getLoanAgainstMF}   timeout=1s
