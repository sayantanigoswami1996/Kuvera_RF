...
Verify Foreign Vacation Questionnaire
    ...
    Wait For Element Visibility  ${KU_W_feature_sg_foreignVacation}
    Click Element  ${KU_W_feature_sg_foreignVacation}
    ...
    Verify Recommendation And Navigation  ${KU_W_feature_sg_dependents}  ${KU_W_feature_sg_haveALoan}  ${KU_W_feature_sg_dualIncome} 