...
Verify Top Gainers Landing Page
    ...
    Verify Login Page
    Verify Filter Navigation For TopGainer and 52WkHighIndia  ${KU_W_invest_topGainerAndIndia_watchListHeader}  ${e_invest_stocks_watchlistHeader}   ${e_invest__52WHighLow_UTF_sortYearText}  ${KU_W_invest_topGainerAndIndia_watchListBtn}