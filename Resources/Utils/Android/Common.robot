...
Begin Mobile Test Kuvera
    Open Application    ${remote_URL}    app=bs://dcdb86b0a23f09ef2292af860651970aa207d38b  name=Launch_Test   build=RobotFramework    platformName=Android    os_version=9.0    device=Google Pixel 3
