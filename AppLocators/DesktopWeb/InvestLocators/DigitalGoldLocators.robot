...
# Dashboard
${KU_W_dg_oneDayReturnVal} =  xpath=//div[@class='b-return-tile__value']
${KU_W_dg_quantLabel} =  xpath=//div[normalize-space()='Quantity']
${KU_W_dg_goldMenu} =  xpath=//div[@class='b-basic-tabs b-dashboard__summary-card--tabs k-scrollbar--hide b-asset-card-container__tabs']
${KU_W_dg_oneDayPerVal} =  xpath=//div[contains(@class,'b-return-tile__percentage')]
${KU_W_dg_quantVal} =  xpath=//span[@class='b-return-tile__value']
# Portfolio
${KU_W_dg_goldPortfolioMenu} =  xpath=(//div[contains(text(),'Gold')])[1]
${KU_W_dg_totalValLabel} =  xpath=//p[normalize-space()='Total Value']
${KU_W_dg_totalVal} =  xpath=//p[@class='b-d-cumulative-gold-row__total-box-value b-d-cumulative-gold-row__total-box-value--total']
${KU_W_dg_qauntPortfolioLabel} =  xpath=//p[normalize-space()='Quantity']
${KU_W_dg_qauntPortfolioVal} =  xpath=(//p[@class='b-d-cumulative-gold-row__total-box-value'])[1]
${KU_W_dg_sellRateVal} =  xpath=(//p[@class='b-d-cumulative-gold-row__total-box-value'])[2]
