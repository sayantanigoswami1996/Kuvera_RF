...
${KU_W_dg_goldRefreshIcon} =  xpath=//img[@class='b-sell-gold__refresh-icon']
${KU_W_dg_goldPurityTitle} =  xpath=(//div[@class='b-sell-gold__cumulative-label'])[1]
${KU_W_dg_goldPartnerTitle} =  xpath=(//div[@class='b-sell-gold__cumulative-label'])[2]
${KU_W_dg_goldPurityAmt} =  xpath=(//div[@class='b-sell-gold__cumulative-unit b-sell-gold__cumulative-unit--widget'])[2]
${KU_W_dg_goldPartnerName} =  xpath=(//div[@class='b-sell-gold__cumulative-unit b-sell-gold__cumulative-unit--widget'])[3]
