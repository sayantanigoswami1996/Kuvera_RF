...
${KU_W_ss_fundLink1} =  xpath=(//a[@class='b-sleep__funds__link'])[1]
${KU_W_ss_fundLink2} =  xpath=(//a[@class='b-sleep__funds__link'])[2]
${KU_W_ss_fundLink3} =  xpath=(//a[@class='b-sleep__funds__link'])[3]
${KU_W_ss_fundLink4} =  xpath=(//a[@class='b-sleep__funds__link'])[4]
