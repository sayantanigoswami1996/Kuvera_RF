...
# Portfolio
${KU_W_ss_savesmartTab} =  xpath=(//div[contains(text(),'SaveSmart')])[1]
${KU_W_ss_currentValLabel} =  xpath=//div[contains(text(),'Current value')]
${KU_W_ss_currentValAmt} =  xpath=//div[@class='b-investment__current__amount']
${KU_W_ss_xirrVal} =  xpath=//div[contains(@class,'b-investment__xirr__amount')]
${KU_W_ss_totalAmtVal} =  xpath=//div[@class='b-investment__total__amount']
${KU_W_ss_monthlySavingsLabel} =  xpath=//div[normalize-space()='Monthly savings']
${KU_W_ss_totAmtLabel} =  xpath=//div[normalize-space()='Total amount saved']
${KU_W_ss_returnsXIRRLabel} =  xpath=//div[contains(text(),'Returns (XIRR)')]
${KU_W_ss_startSavingsTodayLink} =  xpath=//div[contains(text(),'Start saving today >')]