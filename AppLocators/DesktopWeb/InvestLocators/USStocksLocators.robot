...
${KU_W_invest_USStocks_stockInvestLink1} =  xpath=(//button[@class='button-primary b-invest__top-fund__content__item__btn-invest'])[1]
${KU_W_invest_USStocks_stockInvestLink2} =  xpath=(//button[@class='button-primary b-invest__top-fund__content__item__btn-invest'])[2]
${KU_W_invest_USStocks_stockInvestLink3} =  xpath=(//button[@class='button-primary b-invest__top-fund__content__item__btn-invest'])[3]
${KU_W_invest_USStocks_stockInvestLink4} =  xpath=(//button[@class='button-primary b-invest__top-fund__content__item__btn-invest'])[4]
...
${KU_W_invest_USStocks_botQAList} =  xpath=(//div[@class='qa-q-item-main'])[2]
