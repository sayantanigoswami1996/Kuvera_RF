...
${KU_W_famDetails_popupOkayBtn} =  xpath=//button[contains(text(),'Okay')]
...
${KU_W_selectCity_infoLinkOkayBtn} =  xpath=//button[contains(text(),'Okay')]
...
${KU_W_selectCity_OtherAddBtn} =  xpath=//div[contains(text(),'Other')]