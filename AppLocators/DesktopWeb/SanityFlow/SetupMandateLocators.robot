...
${KU_W_mandate_setMandateTitle} =  xpath=//div[contains(text(),'Your mandate is set up')]
${KU_W_mandate_setMandateDesc} =  xpath=//div[contains(text(),'After placing your SIP order, please follow the instructions sent in email to authorize your mandate')]