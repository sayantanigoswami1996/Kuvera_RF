...
${e_SPM_payViaNetBanking} =  NETBANKING AND PAYLATER
...
${KU_W_FM_monthOnCalendar} =  xpath=//span[@class='day__month_btn up']
${KU_W_FM_rightArrow} =  xpath=//div[@class='b-health-input-details__dob']//div[3]//header[1]//span[1]
${KU_W_FM_birthMonth} =  xpath=//span[text()='August']
