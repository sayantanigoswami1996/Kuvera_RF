...
${KU_W_KYC_countrySearchBar} =  xpath=//input[@id='country']
...
${KU_W_KYC_updateBtn} =  xpath=//button[normalize-space()='Update']
...
${KU_W_KYC_IFSCLabel} =  xpath=//label[normalize-space()='IFSC CODE']
${KU_W_KYC_bankAccField} =  xpath=//input[@id='account_number']
${KU_W_KYC_bankAccLabel} =  xpath=//label[normalize-space()='BANK ACCOUNT NUMBER']
${KU_W_KYC_reBankAccField} =  xpath=//input[@id='re_acc_no']
${KU_W_KYC_reBankAccLabel} =  xpath=//label[normalize-space()='CONFIRM BANK ACCOUNT']
${KU_W_KYC_accTypeLabel} =  xpath=//label[normalize-space()='TYPE OF ACCOUNT']
