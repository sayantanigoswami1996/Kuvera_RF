...
${KU_W_rewards_rightScroll} =  xpath=//div[@class='b-karma-reward-banner__page-changer__right']
${KU_W_rewards_goldBanner} =  xpath=//div[contains(text(),'Win ₹1,000 digital gold on your first transfer with Wise.')]
${KU_W_rewards_goldBannerLogo} =  xpath=//img[@class='b-karma-reward-banner__item--remit-img']