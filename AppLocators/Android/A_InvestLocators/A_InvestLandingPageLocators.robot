...
${KU_A_invest_balancedAdvantage_tilesTitle} =  xpath=//*[@text='Balanced advantage']
...
${KU_A_invest_stocks_watchlistTitle} =  xpath=//*[@text='Login to track your favorite stocks by adding them to your watchlist.']
${KU_A_invest_funds_watchlistTitle} =  xpath=//*[@text='Login to track your favorite funds by adding them to your watchlist.']
...
${KU_A_invest_aumInfoImg} =  xpath=(//*[@text='info-icon'])[1]
${KU_A_invest_terInfoImg} =  xpath=(//*[@text='info-icon'])[2]
${KU_A_invest_riskInfoImg} =  xpath=(//*[@text='info-icon'])[2]
...
${KU_A_invest_stocks_noStocks} =  xpath=//*[@text='No stocks available']
...
${KU_A_invest_watchlistBtn} =  xpath=(//*[@class='android.widget.Image'])[6]
