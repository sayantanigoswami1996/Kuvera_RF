...
# To run all test on browserstack : robot --variable environmentToRunTest:Browserstack --variable browserstack_userName:${username} --variable browserstack_accessKey:${accessKey} --variable appURL:${appURL} -d Results Tests/Android/AndroidPreLoginTests.robot
# To run specific test on browserstack : robot --variable environmentToRunTest:Browserstack --variable browserstack_userName:${username} --variable browserstack_accessKey:${accessKey} --variable appURL:${appURL} -d Results -i TC01 Tests/Android/AndroidPreLoginTests.robot
